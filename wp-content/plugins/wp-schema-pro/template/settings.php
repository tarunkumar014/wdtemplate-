							...
							<div class="inside">
								...
								<form method="post" action="options.php">
									...
									<table class="form-table contact-form">
										<tr>
											<th class ="<?php echo empty( $contact_settings['contact-type'] ) ? 'wpsp-required-error-field' : ''; ?>"><?php esc_html_e( 'Contact Type', 'wp-schema-pro' ); ?><span class="sp-required">*</span></th>
										...
										<tr>
											...
											<td><input type="email" name="wp-schema-pro-corporate-contact[email]"  value="<?php echo esc_attr( $contact_settings['email'] ); ?>" placeholder="<?php echo esc_attr( 'e.g. contact@example.com' ); ?>" /></td>
										</tr>
										<tr>
											<th class ="<?php echo empty( $contact_settings['telephone'] ) ? 'wpsp-required-error-field' : ''; ?>"><?php esc_html_e( 'Telephone', 'wp-schema-pro' ); ?><span class="sp-required">*</span>
												<?php
